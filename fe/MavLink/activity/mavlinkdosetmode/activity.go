...
func (a *Activity) Eval(context activity.Context) (done bool, err error)  {
	...
	commandrequest := ardupilotmega.MAV_CMD_DO_SET_MODE	
	
	node := *a.n
	var Param1 float32 = 0
        switch cmd {
		case "MAV_MODE_PREFLIGHT":
			Param1 = float32(ardupilotmega.MAV_MODE_PREFLIGHT)
		case "MAV_MODE_STABILIZE_DISARMED":
			Param1 = float32(ardupilotmega.MAV_MODE_STABILIZE_DISARMED)
		case "MAV_MODE_STABILIZE_ARMED":
			Param1 = float32(ardupilotmega.MAV_MODE_STABILIZE_ARMED)
		case "MAV_MODE_MANUAL_DISARMED":
			Param1 = float32(ardupilotmega.MAV_MODE_MANUAL_DISARMED)
		case "MAV_MODE_MANUAL_ARMED":
			Param1 = float32(ardupilotmega.MAV_MODE_MANUAL_ARMED)
		case "MAV_MODE_GUIDED_DISARMED":
			Param1 = float32(ardupilotmega.MAV_MODE_GUIDED_DISARMED)
		case "MAV_MODE_GUIDED_ARMED":
			Param1 = float32(ardupilotmega.MAV_MODE_GUIDED_ARMED)
		case "MAV_MODE_AUTO_DISARMED":
			Param1 = float32(ardupilotmega.MAV_MODE_AUTO_DISARMED)
		case "MAV_MODE_AUTO_ARMED":
			Param1 = float32(ardupilotmega.MAV_MODE_AUTO_ARMED)
		case "MAV_MODE_TEST_DISARMED":
			Param1 = float32(ardupilotmega.MAV_MODE_TEST_DISARMED)
		case "MAV_MODE_TEST_ARMED":
			Param1 = float32(ardupilotmega.MAV_MODE_TEST_ARMED)
		default:
